  ...
  <div id="login" class="text-center">
    <form class="form-signin" @submit.prevent="login">
      <div class="member-login">
        ...
        <router-link to='/main'><div class="button-section"><button type="submit">Log In</button>
        </div></router-link>
           <div>
        <span>Not a member yet? </span><router-link :to="{ name: 'signup' }">Sign up now!</router-link>
      </div>
      </div>
