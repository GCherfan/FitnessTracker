...
public class FoodController {
    ...
    public Food getFoodById(@Valid @PathVariable int id) throws FoodNotFoundException {
    ...
    @GetMapping(path="/userFoods")
    public Food getAllUserFoods(@RequestBody Food food){
        return dao.getUserFoods(food);
